        ...
        <div class="carousel slide" id="cInfo" data-ride="carousel">
            ...
            <div class="carousel-inner">
                <div class="carousel-item active">
                    ...
                    <img id="cInfo" src="img/info.jpg" class="img-fluid d-block" width="100%">

                    <div class="carousel-caption text-dark d-none d-md-block mb-5">

                        <h1 class="display-1"><strong>Informática</strong></h1>
                        <hr>
                        <p class="lead"><strong>Informática é um termo usado para descrever o conjunto das ciências relacionadas ao armazenamento, transmissão e processamento de informações em meios digitais.</strong></p>
                ...
                <div class="row mb-5">
                    ...
                    <div class="col-sm-12 col-md-8">
                        ...
                        <div data-spy="scroll" data-target="#navbarVertical" data-offset="0" class="scrollspySite">
                            ...
                            <p>O estágio curricular é previsto para a 3º etapa do Curso Técnico em Informática conforme a matriz curricular, devendo ser realizado em 100 horas.</p>
                            ...
                            <p>O Técnico em Informática – Área de Informática deve ser um profissional flexível, ágil e criativo na solução de problemas da área, com visão empresarial e noções básicas sobre gestão de negócios. Deve ser ético, responsável, que trabalhe em equipe e que:</p>
                            <p>- Se mantenha atualizado, e compartilhe conhecimentos e tecnologias;</p>
                            <p>- Possua capacitação de base em lógica de programação, estruturas de dados, bancos de dados, gestão empresarial;</p>
                            ...
                            <p>- Conheça escrituração, instalação, configuração de programas, monitoração e manutenção de computadores em rede;</p>
                            <p>- Conheça os componentes e a origem de falhas no funcionamento de computadores, periféricos e softwares básicos.</p>

                            <h5 id="item6" class="text-center">Objetivos do Curso Técnico em Informática</h5>
                            <p>Formar profissionais de nível técnico com visão empreendedora que atendam ás novas necessidades da vida produtiva e que desenvolvam e adaptam softwares básicos e de sistemas computacionais específicos;</p>
                            <p>Oportunizar condições para um aperfeiçoamento e qualificação profissionais, atendendo a novos paradigmas;</p>
                            <p>Preparar profissionais para o mercado de trabalho, priorizando valores éticos, buscando soluções novas no campo produtivo para melhoria da qualidade de vida.</p>
