...
<head>
  ...
  <meta name="keywords"
    content="maria rocha, escola maria rocha, escola professora maria rocha, escola profª maria rocha, santa maria, RS">
    ...
    <div class="row text-center mt-3 mb-3">
      ...
      <div class="col-sm col-md-3 col-lg-3 col-xl-3 mx-auto mt-3">
        ...
        <div class="btn-group-vertical btn-block btn-block-lg">
          <a href="http://www.educacao.rs.gov.br/inicial" target="_blank" class="btn btn-primary mb-3"
            style="height: 5rem; width: 15rem; display: flex; justify-content: center;align-items: center;">
            <h6 class="text-uppercase">Secretaria da Educação</h6>
          </a>
          <a href="https://secweb.procergs.com.br/rheportal/logon.xhtml" target="_blank" class="btn btn-primary mb-3"
            style="height: 5rem; width: 15rem; display: flex; justify-content: center;align-items: center;">
      ...
      <div class="col-sm col-md-3 col-lg-3 col-xl-3 mx-auto mt-3">
        ...
        <div class="btn-group-vertical btn-block btn-block-lg">
          ...
          <a href="http://portaldoprofessor.mec.gov.br/index.html" target="_blank" class="btn btn-primary mb-3"
            style="height: 5rem; width: 15rem; display: flex; justify-content: center;align-items: center;">
            <h6 class="text-uppercase">Portal do Professor</h6>
          </a>
          <a href="http://www.ufsm.br/" target="_blank" class="btn btn-primary mb-3"
            style="height: 5rem; width: 15rem; display: flex; justify-content: center;align-items: center;">
      ...
      <div class="col-sm col-md-3 col-lg-3 col-xl-3 mx-auto mt-3 mb-3">
        <div class="btn-group-vertical btn-block btn-block-lg">
          <a href="http://portal.mec.gov.br/" target="_blank" class="btn btn-primary mb-3"
            style="height: 5rem; width: 15rem; display: flex; justify-content: center;align-items: center;">
            <h6 class="text-uppercase">MEC</h6>
          </a>
          <a href="http://prouniportal.mec.gov.br/" target="_blank" class="btn btn-primary mb-3"
            style="height: 5rem; width: 15rem; display: flex; justify-content: center;align-items: center;">
      ...
      <div class="col-sm col-md-3 col-lg-3 col-xl-3 mx-auto mt-3">
        ...
        <div class="btn-group-vertical btn-block btn-block-lg">
          ...
          <a href="https://enem.inep.gov.br/#/antes?_k=4k5apg" target="_blank" class="btn btn-primary mb-3 p-2"
            style="height: 5rem; width: 15rem; display: flex; justify-content: center;align-items: center;">
